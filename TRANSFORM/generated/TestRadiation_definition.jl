...
@doc Markdown.doc"""
   TestRadiation(; name, T_a, T_b, surfaceArea, epsilon)
...
| `Q_total`         |                          | W  | 
"""
@component function TestRadiation(; name, T_a=293.15, T_b=313.15, surfaceArea=2, epsilon=0.5)
  ...
  push!(__systems, @named resistance = TRANSFORM.Radiation(surfaceArea=surfaceArea, epsilon=epsilon))
...
export TestRadiation

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TestRadiation)) = print(io,
