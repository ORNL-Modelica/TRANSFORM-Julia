...
@doc Markdown.doc"""
   TestSphere(; name, T_a, T_b, r_inner, r_outer, lambda)
...
| `Q_total`         |                          | W  | 
"""
@component function TestSphere(; name, T_a=293.15, T_b=313.15, r_inner=1, r_outer=2, lambda=5)
  ...
  push!(__systems, @named resistance = TRANSFORM.Sphere(r_inner=r_inner, r_outer=r_outer, lambda=lambda))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TestSphere)) = print(io,
