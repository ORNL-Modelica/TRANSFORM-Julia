...
@doc Markdown.doc"""
   TestContact(; name, T_a, T_b, surfaceArea, Rc_pp)
...
| `Q_total`         |                          | W  | 
"""
@component function TestContact(; name, T_a=293.15, T_b=313.15, surfaceArea=2, Rc_pp=15)
  ...
  push!(__systems, @named resistance = TRANSFORM.Contact(surfaceArea=surfaceArea, Rc_pp=Rc_pp))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TestContact)) = print(io,
