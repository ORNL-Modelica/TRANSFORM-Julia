...
include("Plane_definition.jl")
include("Cylinder_definition.jl")
include("Sphere_definition.jl")
include("Convection_definition.jl")
include("Contact_definition.jl")
include("Radiation_definition.jl")
include("TestPlane_definition.jl")
include("SimTestPlane_definition.jl")
include("TestConvection_definition.jl")
include("SimTestConvection_definition.jl")
include("TestSphere_definition.jl")
include("SimTestSphere_definition.jl")
include("TestContact_definition.jl")
include("SimTestContact_definition.jl")
include("TestRadiation_definition.jl")
include("SimTestRadiation_definition.jl")