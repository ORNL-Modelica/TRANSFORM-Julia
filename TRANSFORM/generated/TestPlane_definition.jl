...
@doc Markdown.doc"""
   TestPlane(; name, T_a, T_b, th, crossArea, lambda)
...
| `Q_total`         |                          | W  | 
"""
@component function TestPlane(; name, T_a=293.15, T_b=313.15, th=1, crossArea=2, lambda=5)
  ...
  push!(__systems, @named resistance = TRANSFORM.Plane(th=th, crossArea=crossArea, lambda=lambda))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TestPlane)) = print(io,
